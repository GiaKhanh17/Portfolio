      ...
      z-10">
        ...
        justify-center">
          ...
          <TextGenerateEffect
            ...
            words="Giải quyết vấn đề không chỉ bằng kiến thức, mà còn bằng thái độ bình tĩnh và trách nhiệm."
          />

          <p className="text-center md:tracking-wider
          mb-4 text-sm md:text-lg lg:text-2xl">
            Chào mừng đến với Portfolio của Vương Gia Khánh.
          </p>

          <a href="#about">
            <MagicButton otherClasses=""
              title="Show my work"
