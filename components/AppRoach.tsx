        ...
        <section className="w-full py-20">
            ...
            gap-4">
                <Card title="Planning & Strategy"
                    ...
                    site stucture, navigation, and content 
                    requirements."
                >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                ...
                <Card title="Development & Progress Update"
                    ...
                    description="
                        Once we agree on the plan, I cue 
...
const Card = ({
    ...
    return (
        <div
            ...
            dark:border-white/[0.2]  max-w-sm w-full 
            mx-auto p-4 relative lg:h-[35rem] rounded-3xl"
        >
            <Icon className="absolute h-6 w-6 -top-3 
            -left-3 dark:text-white text-black" />
            <Icon className="absolute h-6 w-6 -bottom-3 
            -left-3 dark:text-white text-black" />
            ...
            <div className="relative z-20">
                ...
                group-hover/canvas-card:-translate-y-2 transition 
                ...
                group-hover/canvas-card:text-white 
                group-hover/canvas-card:-translate-y-2 transition 
                duration-200 text-center" style={{ color: '#e4ecff' }}>
                    {description}
                </h2>
            </div>
        </div>
...
const AceternityIcon = ({ order }: { order: string }) => {
    return (
        <div>
            ...
            overflow-hidden rounded-full p-[1px] focus:outline-none 
            ...
            focus:ring-offset-slate-50">
                ...
                font-medium text-white backdrop-blur-3xl">
                    <span className="inline-flex h-full w-full 
                    cursor-pointer items-center justify-center 
                    rounded-full bg-slate-950 px-5 py-2 
